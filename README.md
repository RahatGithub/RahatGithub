...
<svg width="1200" height="320" viewBox="0 0 1200 320" xmlns="http://www.w3.org/2000/svg">
    ...
    <linearGradient id="bgGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#0d1b2a">
        <animate attributeName="stop-color"
                 values="#0d1b2a;#1b2a4e;#2a1b3a;#0d1b2a"
                 dur="20s"
                 repeatCount="indefinite"/>
      </stop>
      <stop offset="50%" stop-color="#1a1a40">
        <animate attributeName="stop-color"
                 values="#1a1a40;#240046;#1e3a5f;#1a1a40"
                 dur="20s"
                 repeatCount="indefinite"/>
      </stop>
      <stop offset="100%" stop-color="#1a0b2e">
        <animate attributeName="stop-color"
                 values="#1a0b2e;#0d1b2a;#240046;#1a0b2e"
                 dur="20s"
                 repeatCount="indefinite"/>
      </stop>
    </linearGradient>

    <!-- Color-shifting text gradient -->
    <linearGradient id="textGrad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#00f5ff">
        <animate attributeName="stop-color"
                 values="#00f5ff;#a855f7;#ec4899;#f59e0b;#00f5ff"
                 dur="10s"
                 repeatCount="indefinite"/>
      </stop>
      ...
      <stop offset="100%" stop-color="#a855f7">
        <animate attributeName="stop-color"
                 values="#a855f7;#ec4899;#f59e0b;#00f5ff;#a855f7"
                 dur="10s"
                 repeatCount="indefinite"/>
      </stop>
    </linearGradient>

    <!-- Shine gradient for sweep effect -->
    <linearGradient id="shineGrad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="white" stop-opacity="0"/>
      <stop offset="50%" stop-color="#00f5ff" stop-opacity="0.18"/>
  ...
  <g opacity="0">
    ...
    <text x="540" y="275" font-family="'Courier New', monospace" font-size="13" fill="#10b981" letter-spacing="3">
      ONLINE
    </text>
...
<a href="https://github.com/RahatGithub">
  <img src="https://img.shields.io/badge/GitHub-0a0e27?style=for-the-badge&logo=github&logoColor=a855f7&labelColor=0a0e27" alt="GitHub"/>
</a>
